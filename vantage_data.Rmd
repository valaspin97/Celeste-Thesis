...
##5b. create the master sequence, 31 days, 15 min interval, should end up with 2880 observations 
...
#6. merge with data_set25: sep25_final
...
start_nov25 <- as.POSIXct("2025-11-01 00:15:00")
end_nov25   <- as.POSIXct("2025-12-01 00:00:00")
...
```{r}
#8. trying to use plotly to see where the gaps are monthly 
fig_jun25_rain <- plot_ly(width = 900, height = 500) %>%
  # create plot with rain as main variable
  add_trace(data = jun25_final, x = ~`DateTime`, y = ~`NA_Rain`, 
            name = 'Precipitation', type = 'scatter', mode = 'lines',
            line = list(width = 0.8))
